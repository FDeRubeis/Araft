...
def main(args):
    ...
    traj_to_DPO(dataset, tokenizer, args.templates_dir, args.outfile)


if __name__ == "__main__":

    parser = argparse.ArgumentParser(
        description="Converts trajectories to DPO training data"
    )
    ...
    parser.add_argument(
        "-o",
        "--outfile",
        help="File path to output the DPO training data. Must have csv extension",
        type=Path,
        default=OUTPUT_DIR / "DPOdata.csv",
    )
    parser.add_argument(
        "--templates-dir",
